...
public Xls_Reader(String path) {
		...
		try {
			...
			fis.close();
			System.out.println("trace XLS_Reader_constructor finishes");
		} catch (Exception e) {
		...
		public String getCellData(String sheetName,String colName,int rowNum){
			try{
				if(rowNum <=0)
					return "";
			System.out.println("trace XLS_Reader_getcell data_input is:");
			...
			if(cell.getCellTypeEnum()== CellType.STRING)
				  ...
				  if (HSSFDateUtil.isCellDateFormatted(cell)) {
					...
					System.out.println("trace XLS_Reader_getcell data_Output is:");
					System.out.println(cellText);
